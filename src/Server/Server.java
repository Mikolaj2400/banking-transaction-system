                ...
                try {
                    ...
                    if (line.equals(fileNameKowalski)) { //sprawdza plik Kowalski
                        ...
                        if (line.equals(passwordKowalski)) {
                            out.writeBytes( "Poprawne haslo, udalo sie zalogowac" + "\n\r");
                            System.out.println("Wysłano linię: " + "Poprawne haslo, udalo sie zalogowac");
                        } else {
...
//            while (whilePassword) {
//                try {
//                    //odczytywanie drugiej linii od klienta (haslo, ktore jest podane w pliku)
//                    String line = brinp.readLine();
//                    System.out.println("Odczytano linię: " + line);
//                    //za kazdym razem, gdy klient wpisuje cos do konsoli trzeba sprawdzic czy nie wpisal quit zeby wyjsc
//                    if (line == null || "quit".equals(line)) {
...
//                    if (line.equals(passwordKowalski)) {
//                        out.writeBytes("Poprawne haslo, udalo sie zalogowac");
//                        System.out.println("Poprawne haslo, udalo sie zalogowac");
//                    } else {
//                        out.writeBytes("Niepoprawne haslo");
